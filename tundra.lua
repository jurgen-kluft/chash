...
Build {
  ...
  Units = function ()
    ...
    local unittest = Program {
      Name = "xhash_unittest",
      Depends = { xhash_lib, xbase_lib, xunittest_lib },
      Sources = { SourceGlob("source/test/cpp") },
      Includes = { "source/test/include/", xhash_inc, xbase_inc, xunittest_inc },
    }
