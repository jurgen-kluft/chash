...
#define MK_64 SKEIN_MK_64
        ...
        const u64 SKEIN_256_IV_224[] = {MK_64(0xC6098A8C, 0x9AE5EA0B), MK_64(0x876D5686, 0x08C5191C), MK_64(0x99CB88D7, 0xD7F53884), MK_64(0x384BDDB1, 0xAEDDB5DE)};
        ...
        const u64 SKEIN_512_IV_160[] = {MK_64(0x28B81A2A, 0xE013BD91), MK_64(0xC2F11668, 0xB5BDF78F), MK_64(0x1760D8F3, 0xF6A56F12), MK_64(0x4FB74758, 0x8239904F),
                                        MK_64(0x21EDE07F, 0x7EAF5056), MK_64(0xD908922E, 0x63ED70B8), MK_64(0xB8EC76FF, 0xECCB52FA), MK_64(0x01A47BB8, 0xA3F27A6E)};

        /* blkSize =  512 bits. hashSize =  224 bits */
        const u64 SKEIN_512_IV_224[] = {MK_64(0xCCD06162, 0x48677224), MK_64(0xCBA65CF3, 0xA92339EF), MK_64(0x8CCD69D6, 0x52FF4B64), MK_64(0x398AED7B, 0x3AB890B4),
                                        MK_64(0x0F59D1B1, 0x457D2BD0), MK_64(0x6776FE65, 0x75D4EB3D), MK_64(0x99FBC70E, 0x997413E9), MK_64(0x9E2CFCCF, 0xE1C41EF7)};

        /* blkSize =  512 bits. hashSize =  256 bits */
        const u64 SKEIN_512_IV_256[] = {MK_64(0xCCD044A1, 0x2FDB3E13), MK_64(0xE8359030, 0x1A79A9EB), MK_64(0x55AEA061, 0x4F816E6F), MK_64(0x2A2767A4, 0xAE9B94DB),
                                        MK_64(0xEC06025E, 0x74DD7683), MK_64(0xE7A436CD, 0xC4746251), MK_64(0xC36FBAF9, 0x393AD185), MK_64(0x3EEDBA18, 0x33EDFC13)};

        /* blkSize =  512 bits. hashSize =  384 bits */
        const u64 SKEIN_512_IV_384[] = {MK_64(0xA3F6C6BF, 0x3A75EF5F), MK_64(0xB0FEF9CC, 0xFD84FAA4), MK_64(0x9D77DD66, 0x3D770CFE), MK_64(0xD798CBF3, 0xB468FDDA),
                                        MK_64(0x1BC4A666, 0x8A0E4465), MK_64(0x7ED7D434, 0xE5807407), MK_64(0x548FC1AC, 0xD4EC44D6), MK_64(0x266E1754, 0x6AA18FF8)};

        /* blkSize =  512 bits. hashSize =  512 bits */
        const u64 SKEIN_512_IV_512[] = {MK_64(0x4903ADFF, 0x749C51CE), MK_64(0x0D95DE39, 0x9746DF03), MK_64(0x8FD19341, 0x27C79BCE), MK_64(0x9A255629, 0xFF352CB1),
...
#define SKEIN1024_BLOCK_BYTES (8 * SKEIN1024_STATE_WORDS)
        ...
        s32 Skein_256_Update(Skein_256_Ctxt_t* ctx, const u8* msg, u32 msgByteCnt);
        s32 Skein_512_Update(Skein_512_Ctxt_t* ctx, const u8* msg, u32 msgByteCnt);
        s32 Skein1024_Update(Skein1024_Ctxt_t* ctx, const u8* msg, u32 msgByteCnt);

        s32 Skein_256_Final(Skein_256_Ctxt_t* ctx, u8* hashVal);
        s32 Skein_512_Final(Skein_512_Ctxt_t* ctx, u8* hashVal);
        s32 Skein1024_Final(Skein1024_Ctxt_t* ctx, u8* hashVal);
...
#define Skein_Swap64(w64) (w64)
        ...
        void Skein_Put64_LSB_First(u8* dst, const u64* src, u32 bCnt)
        ...
        void Skein_Get64_LSB_First(u64* dst, const u8* src, u32 wCnt)
        { /* this version is fully portable (big-endian or little-endian), but slow */
            u32 n;
...
#error "need more unrolling in Skein_1024_Process_Block"
        ...
        s32 Skein_512_Init(Skein_512_Ctxt_t* ctx, u32 hashBitLen)
        {
            ...
            { /* use pre-computed values, where available */
                ...
                case 160: memcpy(ctx->X, SKEIN_512_IV_160, sizeof(ctx->X)); break;
                default:
                    /* here if there is no precomputed IV value available */
                    /* build/process the config block, type == CONFIG (could be precomputed) */
                    Skein_Start_New_Type(ctx, CFG_FINAL); /* set tweaks: T0=0; T1=CFG | FINAL */
    ...
    void skein256_t::hash(cbuffer_t const& data)
    {
        skein::Skein_256_Ctxt_t* ctx = (skein::Skein_256_Ctxt_t*)&m_ctxt;
        if (m_initialized)
    ...
    void skein256_t::end(nhash::skein256& hash)
    {
        skein::Skein_256_Ctxt_t* ctx = (skein::Skein_256_Ctxt_t*)&m_ctxt;
        if (m_initialized)
        {
            ...
            skein::Skein_256_Final(ctx, hash.m_data);
        }
    }

    void skein256_t::compute(cbuffer_t const& data, nhash::skein256& h)
    {
        reset();
        compute(data);
        end(h);
    ...
    nhash::skein256 skein256_t::compute(cbuffer_t const& data)
    {
        nhash::skein256 hash;
        compute(data, hash);
        return hash;
    ...
    void skein512_t::end(nhash::skein512& hash)
    {
        skein::Skein_512_Ctxt_t* ctx = (skein::Skein_512_Ctxt_t*)&m_ctxt;
        if (m_initialized)
        {
            m_initialized = false;
            ASSERT(hash.size() >= size());
            skein::Skein_512_Final(ctx, hash.m_data);
        }
    }

    void skein512_t::compute(cbuffer_t const& data, nhash::skein512& hash)
    {
        reset();
        compute(data);
        end(hash);
    ...
    nhash::skein512 skein512_t::compute(cbuffer_t const& data)
    {
        nhash::skein512 hash;
        compute(data, hash);
        return hash;
    ...
    void skein1024_t::end(nhash::skein1024& hash)
    {
        skein::Skein1024_Ctxt_t* ctx = (skein::Skein1024_Ctxt_t*)&m_ctxt;
        if (m_initialized)
        {
            m_initialized = false;
            ASSERT(hash.size() >= size());
            skein::Skein1024_Final(ctx, hash.m_data);
        }
    }

    void skein1024_t::compute(cbuffer_t const& data, nhash::skein1024& hash)
    {
        reset();
        compute(data);
        end(hash);
    ...
    nhash::skein1024 skein1024_t::compute(cbuffer_t const& data)
    {
        nhash::skein1024 hash;
        compute(data, hash);
        return hash;
    }
